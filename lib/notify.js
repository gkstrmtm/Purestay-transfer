const { getJson, setJson, appendLog } = require('./storage');
...
async function notifyEmail({ to, cc, bcc, subject, text, html, dedupKey, onceWithinMinutes = 360 }) {
...
async function notifySms({ to, body, dedupKey, onceWithinMinutes = 180 }) {
